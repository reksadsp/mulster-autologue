...
## Caractéristique physique de l'instrument
...
Pour les instruments neufs/récents : 
    - Site du constructeur
Pour les instruments vintage :
    - Site du constructeur (sections deprecated ou legacy)
    - https://fr.audiofanzine.com/
Attention !
    Si tu ne trouves pas de largeur pendant ta recherche, et uniquement si tu ne la trouve nulle part, alors rabats-toi sur la Largeur de l'instrument.
...
Répondre par une seule grandeur en cm.
Exemple : 29.9
Ne réponds pas '0.0' ou bien des mots comme 'Longueur', sinon ta réponse ne sera pas validée.
